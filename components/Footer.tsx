        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/products" className="text-gray-400 hover:text-red-400 transition-colors">Products</a></li>
              <li><a href="/#testimonials" className="text-gray-400 hover:text-red-400 transition-colors">Reviews</a></li>
              <li><a href="/#community" className="text-gray-400 hover:text-red-400 transition-colors">Community</a></li>
              <li><a href="/disclaimers" className="text-gray-400 hover:text-red-400 transition-colors">Disclaimers</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors">Warranty Info</a></li>
              <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors">Returns</a></li>
            ...
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex space-x-4">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-gray-800 hover:bg-black text-white p-3 rounded-full transition-colors"
                  title="TikTok"
                >
                  <span className="text-xl">🎵</span>
                </a>
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex">
                <input 
                  ...
                  className="bg-gray-800 text-white px-4 py-2 rounded-l-lg border border-gray-700 focus:outline-none focus:border-red-500"
                />
                <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-r-lg font-bold transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
